...
.controller('pianoCtrl', 
  function ($scope, $stateParams,$ionicPlatform, $timeout, $cordovaNativeAudio,Informacion,$cordovaFile,$cordovaVibration,$ionicPopup) {
   var vm = this;
      ...
      try{
        $ionicPlatform.ready(function() {
          ...
          .then(function (success) {
            $ionicPopup.alert({
              title: 'Guardo!',
              template: 'Se ah guardado los cambios !!'
